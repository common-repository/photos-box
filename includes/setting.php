...
function photo_box_init_theme_opotion() {
	...
	// add_settings_field('photo_box_display[delete]', 'delete','delete','photo_box-display-section','photo_box_display_section');
	add_settings_field('photo_box_display[test]', 'test','test','photo_box-display-section','photo_box_display_section');
